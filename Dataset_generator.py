import ClipVideo.clipvideo.videoclipper
import os
...
video_tools = ClipVideo.clipvideo.videoclipper.VideoClipper(inference_pipeline)
STAGE_RECOGNIZE = 1
STAGE_CLIP = 2
...
FONT_COLOR = 'white'
ADD_SUB = False
OUTPUT_SRT_FILE = "ClipVideo/output/srt"
OUTPUT_MP4_FILE = "ClipVideo/output/mp4/"
OUTPUT_WAV_FILE = "ClipVideo/output/wav"
INPUT_FILE_PATH = "./video_files/"
